    ...
    challenges: [
      {
        ...
        quote: '"If I\'m out, things stop." "Only Sarah knows how that works."',
      ...
      },
      {
        ...
        quote: '"We just know how we do it." "Training new people takes forever."',
      ...
      },
      {
        ...
        quote: '"We\'re always putting out fires." "Same issues keep coming back."',
      ...
      },
      {
        ...
        quote: '"We\'re busy but not sure we\'re making money on each job or service."',
      ...
      },
      {
        ...
        quote: '"Things fall through the cracks." "We duplicate work or miss steps."',
      ...
      },
      {
        ...
        quote: '"Adding one more client would break us." "We don\'t know our real capacity."',
    ...
    challenges: [
      {
        ...
        quote: '"Nothing talks to each other." "We re-enter the same data everywhere."',
      ...
      },
      {
        ...
        quote: '"We send the same reports every week by hand." "Invoicing and follow-ups take forever."',
      ...
      },
      {
        ...
        quote: '"We don\'t have good numbers on revenue by service, margin, or utilization."',
      ...
      },
      {
        ...
        quote: '"Our system worked when we were smaller." "We need to move but don\'t know to what."',
      ...
      },
      {
        ...
        quote: '"Customer info is in email, spreadsheets, and our old system." "We can\'t easily see history or status."',
      ...
      },
      {
        ...
        quote: '"We\'re not sure we\'re using the right tools." "Subscriptions add up and we don\'t know what we need."',
              ...
              <div className="challenges-grid">
                {group.challenges.map((card, cardIndex) => (
                  <div key={cardIndex} className="challenge-card">
                    ...
                    <p className="challenge-quote">{card.quote}</p>
