          ...
          <div className="highlight-box">
            <div className="about-content-wrapper">
              <div className="about-text">
                ...
                <p>Roots are continuously growing to add to the strength of the tree. Roots form to continue to grow and add nutrients. Roots continue to build upon each other.</p>
                ...
                <p>At Fresh Roots, we want to continuously improve ourselves and our clients. Like roots that strengthen the foundation of a tree, we strengthen the foundation of your business operations and technology.</p>
                <p style={{ backgroundColor: 'rgba(198, 198, 198, 0.9)', padding: '1rem', borderRadius: '8px', marginTop: '1.5rem', marginBottom: '1.5rem' }}>Our goal is to strengthen ourselves and strengthen our clients by staying focused on helping small businesses develop into a long term sustained business. This reflects our core belief in building <em><span style={{ color: '#FFEB3B' }}>from strength to strength</span></em>&mdash;each improvement compounds and creates the foundation for the next.</p>
